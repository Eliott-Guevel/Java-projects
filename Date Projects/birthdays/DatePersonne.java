...
public class DatePersonne {
	...
	public DatePersonne(int jour, int mois, int annee, String personne) throws DateException {
		if (annee < ANNEE_MIN) {
	...
	public String toString() {
		if ((jour < 10) && (mois < 10)) {
			return personne + " : " + "0" + jour + "/" + "0" + mois + "/" + annee;
		}
		if (mois < 10) {
			return personne + " : " + jour + "/" + "0" + mois + "/" + annee;
		}
		if (jour < 10) {
			return personne + " : " + "0" + jour + "/" + mois + "/" + annee;
		}
		return personne + " : " + jour + "/" + mois + "/" + annee;
	}
